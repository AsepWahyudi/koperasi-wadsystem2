...
function renderTableData(numData, data) {
    ...
    $.each(data, function(i, obj) {
        ...
        var keterangan	=	(obj.LUNAS === 'Lunas' ? '<span class="badge b-rounded x-success">Lancar</span>' : 
                            ...
                            ((obj.TEMPO_FIRST_NUMB === obj.NOW_NUMB) && (obj.TEMPO_SECOND_NUMB > obj.NOW_NUMB) ? '<span class="badge b-rounded x-warning">Meragukan</span>' : 

                            ((obj.TEMPO_SECOND_NUMB === obj.NOW_NUMB) && (obj.TEMPO_THIRD_NUMB > obj.NOW_NUMB) ? '<span class="badge b-rounded x-danger">Buruk</span>' 
                            : '<span class="badge b-rounded x-danger">Macet</span>' ))));
