...
function renderTableData(numData, data){
	...
	$.each(data, function(i, obj) {
		...
		var hitungan = '<table class="table-custom">';
			...
			hitungan += '<tr><td>Angsuran Dasar</td> <td>:</td> <td>' + rupiah(obj.ANGSURAN_DASAR) + '</td></tr>';
			hitungan += '<tr><td>Basil Dasar</td> <td>:</td> <td>' + rupiah(obj.BASIL_DASAR) + '</td></tr>';
			hitungan += '</table>';
		
		var tagihan = '<table class="table-custom">';
			// tagihan += '<tr><td>Jml Angsuran</td> <td>:</td> <td>' + obj.JML_ANGSURAN + '</td></tr>';
			tagihan += '<tr><td>Jml Angsuran</td> <td>:</td> <td>' + rupiah(eval(obj.ANGSURAN_DASAR) + eval(obj.BASIL_DASAR)) + '</td></tr>';
			tagihan += '<tr><td>Jml Denda</td> <td>:</td> <td>' + obj.JML_DENDA + '</td></tr>';
			// tagihan += '<tr><td>Total Tagihan</td> <td>:</td> <td>' + obj.TOTAL_TAGIHAN + '</td></tr>';
			tagihan += '<tr><td>Total Tagihan</td> <td>:</td> <td>' + rupiah(obj.TOTALPINJAMAN) + '</td></tr>';
			tagihan += '<tr><td>Sudah Bayar</td> <td>:</td> <td>' + rupiah(obj.SUDAH_DIBAYAR) + '</td></tr>';
			tagihan += '<tr><td>Sisa Angsuran</td> <td>:</td> <td>' + obj.SISA_ANGSURAN + '</td></tr>';
			if(obj.BIAYARESET > 0)
			{ 
				tagihan += '<tr><td>Sisa Tagihan</td> <td>:</td> <td>0</td></tr>';
			}
			else
			{
			...
			tagihan += '<tr><td>Biaya Reset</td> <td>:</td> <td>' + rupiah(obj.BIAYARESET) + '</td></tr>';
			tagihan += '<tr><td>Biaya Kolektor</td> <td>:</td> <td>' + rupiah(obj.BIAYAKOLEKTOR) + '</td></tr>';
			tagihan += '</table>';
