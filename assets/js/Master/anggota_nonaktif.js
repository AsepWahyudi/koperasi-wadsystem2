...
function renderTableData(numData, data) {
    ...
    $.each(data, function(i, obj) {
        ...
        image = "<a href='" + base_url + "uploads/identitas/" + file_pic + "' title='Foto Anggota'><img src='" + base_url + "uploads/identitas/" + file_pic + "' class='img-responsive'></a>";
        btnEdit = "<a href='" + base_url + "edit-anggota/" + obj.IDANGGOTA + "' class='btn btn-warning btn-sm'><i class='fa fa-edit'></i></a>";
        btnView = "<a href='" + base_url + "view-anggota-nonaktif/" + obj.IDANGGOTA + "' class='btn btn-info btn-sm'><i class='fa fa-eye'></i></a>";
        tableData += "<tr>" +
            "<td><b>" + numData + "</b></td>" +
            "<td><div class='profile-photo gallery-wrap'>" + image + "</div></td>" +
