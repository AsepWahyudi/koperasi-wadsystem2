...
function renderTableData(numData, data){
	...
	$.each(data, function(i, obj) {
		var btnStruk = "<a href='"+base_url+"struk-simpanan/"+obj.ID_TRX_SIMP+"' class='btn btn-info btn-sm'><i class='fa fa-print'></i></a> <a href='"+base_url+"struk-setoran/"+obj.ID_TRX_SIMP+"' class='btn btn-warning btn-sm'><i class='fa fa-print'></i></a>";
		tableData += "<tr>"+
						"<td><b>"+numData+"</b></td>"+
						"<td>"+obj.TGL_TRX+"</td>"+
