...
class Kas_simpanan extends CI_Controller {
	...
	public function index(){
        ...
        $data['PAGE_TITLE']       = "Laporan Kas Simpanan";
		$data['page']             = "laporan/kas_simpanan";
	...
	public function data(){
		...
		$dataTable   = $this->ModelLaporan->getKasSimpanan($keyword, $dataPerPage, $page, $this->input->post());
