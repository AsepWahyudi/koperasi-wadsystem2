...
class Kas_pinjaman extends CI_Controller {
	...
	public function index(){
        ...
        $data['PAGE_TITLE']       = "Laporan Kas Pinjaman";
		$data['page']             = "laporan/kas_pinjaman";
	...
	public function data(){
		...
		$dataTable   = $this->ModelLaporan->getKasPinjaman($keyword, $dataPerPage, $page, $this->input->post());
