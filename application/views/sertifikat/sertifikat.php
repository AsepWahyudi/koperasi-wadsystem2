        ...
        <div class="panel-content">
			<div class="row">
				<div class="col-sm-4 col-lg-4">
					<h4 class="color-primary">Data Jaminan Pinjaman</h4>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<form class="form-inline" action="#" method="POST" id="filterForm"> 
						...
						<input type="hidden" name="urltarget" id="urltarget" value="sertifikat/sertifikat/datajaminan"/>
					</form>
				</div>
			</div>				  
		</div>
					...
					<table class="table table-striped table-lightfont table-customX font-small">
						<thead>
							<tr>
		                        ...
		                        <th class="width1">Jenis Jaminan</th>
		                        <th class="width1">No Jaminan</th>
...
<script src="<?php echo base_url();?>assets/js/pinjaman/jaminan.js"></script>
<style type = "text/css">
  @media print {
