...
<div class="element-box">
			...
			<div class="form-inline justify-content-sm-end">
			  ...
			  <form class="form-inline" action="" method="POST" id="filterForm">
				...
				<input type="hidden" name="dataperpage" id="dataperpage" value="10"/>
				 <input type="hidden" name="urltarget" id="urltarget" value="laporan/jurnal_umum/data"/>
			  </form>
			</div>
		  </div>
		</div>
    ...
    <div class="table-responsive" id="table-view">
		 <div class="dataTables_wrapper container-fluid dt-bootstrap4">
			<table class="table table-bordered table-lightfont font-small">
				<thead>
					<tr>
						<tr>
							<th scope="col">No</th>
							<th scope="col">Tanggal</th>
							<th scope="col" width="300px">Uraian</th>
...
<script type="text/javascript" src="<?php  echo base_url();?>assets/js/laporan/jurnalumum.js?v=1.2.3"></script>