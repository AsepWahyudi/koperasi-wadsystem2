<h6 class="element-header">
    Laporan Jatuh Tempo Pembayaran Kredit
</h6>
              ...
              <div class="col-sm-6 justify-content-sm-end">
                <div class="form-inline justify-content-sm-end">
                  <form class="form-inline" action="#" method="POST" id="filterForm">
                    ...
                    <input type="hidden" name="urltarget" id="urltarget" value="laporan/jatuh_tempo/data"/>
                  </form>
                </div>
              </div>
...
<script type="text/javascript" src="<?php  echo base_url();?>assets/js/laporan/jatuhtempo.js?v=<?php  echo date('ymdhis')?>"></script>