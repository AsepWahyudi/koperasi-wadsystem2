        ...
        <div class="panel-content">
			<div class="row">
				<div class="col-sm-10 col-lg-10">
					<h4 class="color-primary">Laporan Neraca Saldo</h4>
				</div> 
			</div>
        </div>
		<div class="panel-header b-primary bt-sm" style ='border-radius: 0px 0px 0px 0px;'>
			<form class="form-inline" action="#" method="POST" id="filterForm" style ='text-align: center;'>
			<div class="row">
				<div class="col-sm-4">
				...
				<div class="col-sm-8">
					<!--form class="form-inline flr" action="#" method="POST" id="filterForm"-->
						...
						<input type="hidden" name="urltarget" id="urltarget" value="laporan/neraca/data"/>
				</div>
			</div>
			</form>
		</div>
...
<div class="col-sm-12">
    <div class="panel"> 
		...
		<!--div class="panel-content">
			<div class="row">
				<div class="col-sm-10 col-lg-10">
					<h4 class="color-primary">Aktiva</h4>
				</div> 
			</div>
        </div-->
        <div class="panel-content">
...
<script type="text/javascript" src="<?php  echo base_url();?>assets/js/laporan/neraca.js?date=<?php  echo date('ymdhis')?>"></script>