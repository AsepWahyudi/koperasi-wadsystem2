		...
		<div class="panel-content">
			<div class="row">
				<div class="col-sm-9 col-lg-9">
					<h4 class="color-primary">Data Transaksi Pengeluaran Kas Tunai</h4>
				</div>
				<div class="col-sm-3  col-lg-3">
					<a href="<?php echo base_url(); ?>kas-pengeluaran-add" class="btn btn-primary btn-block">
				...
				<tbody>
					<?php if ($data_source->num_rows() > 0) {
						...
						foreach ($data_source->result() as $key) {
							$no = $n++;
							$btn_edit	=	'<a href="' . base_url() . 'kas-pengeluaran-edit?id=' . $key->IDTRAN_KAS . '" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>';
							$btn_del	=	'<a href="' . base_url() . 'transaksi_kas/pengeluaran/delete?id=' . $key->IDTRAN_KAS . '" class="btn btn-danger btn-sm" style="margin-left:3px;"><i class="fa fa-trash"></i></a>';
					?>
							<tr>
								<td><?php echo $no ?></td>
