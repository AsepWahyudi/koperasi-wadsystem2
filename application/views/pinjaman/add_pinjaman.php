        ...
        <div class="panel-content">
            ...
            <form id="formPinjaman" action="pinjaman/pinjaman/save" method="post" class="formValidate">
				...
				<div class="row">
                	<div class="col-sm-6">
						<div class="form-group">
                        	<label for="">Biaya Admin(Rp) :</label>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input class="form-control" type="text" value="0" name="bunga_admin_txt" id="bunga_admin_txt">
						</div>
					</div>
                </div>
				<div class="row">
                	<div class="col-sm-6">
						<div class="form-group">
                        	<label for="">Biaya Asuransi(Rp) :</label>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input class="form-control" type="text" value="0" name="bunga_asuransi_txt" id="bunga_asuransi_txt">
						</div>
					</div>
                </div> 
                <div class="row">
...
<script> 
	...
	$('#bunga_admin_txt').keyup(function(){
        _jumlah = eval($('#jumlah').val().replace(/\,/g, ''));
        _bunga = eval($('#bunga_admin_txt').val().replace(/\,/g, ''));
        _bunga_2 = _bunga * _jumlah / 100;
        _bunga_1 = (Math.round(_bunga_2 / 100) * 100);
        $('#biaya_adm_txt').val(rupiah(_bunga_1));
    }).focus(function(){ $(this).select() });
	
	$('#bunga_asuransi_txt').keyup(function(){
        _jumlah = eval($('#jumlah').val().replace(/\,/g, ''));
        _bunga = eval($('#bunga_asuransi_txt').val().replace(/\,/g, ''));
        _bunga_2 = _bunga * _jumlah / 100;
        _bunga_1 = (Math.round(_bunga_2 / 100) * 100);
        $('#biaya_asuransi_txt').val(rupiah(_bunga_1));
    }).focus(function(){ $(this).select() });
	...
	$('#biaya_adm_txt').keyup(function(){
        _bunga_1 = eval($('#biaya_adm_txt').val().replace(/\,/g, ''));
		$(this).val(rupiah(_bunga_1));
        _jumlah = eval($('#jumlah').val().replace(/\,/g, ''));
        _bunga_rp = eval($('#biaya_adm_txt').val().replace(/\,/g, ''));
        _bunga_1 = _bunga_rp / _jumlah * 100;
        $('#bunga_admin_txt').val(_bunga_1); 
	}).focus(function(){ $(this).select() });
	
	$('#biaya_asuransi_txt').keyup(function(){
        _bunga_1 = eval($('#biaya_asuransi_txt').val().replace(/\,/g, ''));
		$(this).val(rupiah(_bunga_1));
        _jumlah = eval($('#jumlah').val().replace(/\,/g, ''));
        _bunga_rp = eval($('#biaya_asuransi_txt').val().replace(/\,/g, ''));
        _bunga_1 = _bunga_rp / _jumlah * 100;
        $('#bunga_asuransi_txt').val(_bunga_1); 
	}).focus(function(){ $(this).select() });
