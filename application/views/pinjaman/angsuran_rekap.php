        ...
        <div class="panel-content">
                <div class="row">
                    <div class="col-sm-10 col-lg-10">
                        <h4 class="color-primary">Rekap Angsuran Pinjaman</h4>
                    </div>
				...
				<div class="col-sm-6">
					<form class="form-inline flr" action="" method="POST" id="filterForm">
						...
						<input type="hidden" name="dataperpage" id="dataperpage" value="10"/>
						 <input type="hidden" name="urltarget" id="urltarget" value="pinjaman/angsuran/datarekapangsuran"/>
					  </form>
				</div>
			</div>				  
		</div>
...
<script src="<?php  echo base_url();?>assets/js/pinjaman/rekapangsuran.js?v=2"></script>
<style type = "text/css">
      @media print {
