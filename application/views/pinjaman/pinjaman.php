        ...
        <div class="panel-content">
			<div class="row">
				<div class="col-sm-4 col-lg-4">
					<h4 class="color-primary">Data Transaksi Pinjaman</h4>
				</div>
				<div class="col-sm-2 col-lg-2">
					<a href="<?php  echo base_url();?>pinjaman-add" class="btn btn-primary btn-block" >
				...
				<div class="col-sm-2 col-lg-2">
					<a href="<?php  echo base_url();?>pinjaman/pinjaman/pinjaman_excel" class="btn btn-success btn-block" >
						<i class="fa fa-table"></i> 
						Export Excel
					</a>
				</div>
				<div class="col-sm-2 col-lg-2">
					<a href="<?php  echo base_url();?>pinjaman/importpinjaman" class="btn btn-success btn-block" >
						<i class="fa fa-table"></i> 
						Import Excel
					</a>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<form class="form-inline" action="#" method="POST" id="filterForm">
						...
						<input type="hidden" name="urltarget" id="urltarget" value="pinjaman/pinjaman/datapinjaman"/>
					</form>
				</div>
			</div>				  
		</div>
	    ...
	    <div class="panel-content">
		    ...
		    <div class="table-responsive" id="table-view">
				...
				<div class="dataTables_wrapper dt-bootstrap4">
					...
					<table class="table table-striped table-lightfont table-customX font-small">
						<thead>
							<tr>
		                        <th class='width1'>No</th>
		                        <th class="width1">Tgl Pinjam</th>
		                        <th class="width1">No Rek</th>
		                        <th class="width1">Nama Anggota</th>
		                        <th class="width1">Alamat</th>
		                        <th class="width1">Hitungan</th>
		                        <th class="width1">Total Tagihan</th>
		                        <th class="width1">Lunas</th>
		                        <th class="width1">User</th>
		                        <th scope="col" class="text-center print-hide">Action</th>
		                    </tr>
						</thead>
						<tbody></tbody>
					</table>
