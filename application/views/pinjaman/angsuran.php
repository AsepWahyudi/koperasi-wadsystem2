        ...
        <div class="panel-content">
                <div class="row">
                    <div class="col-sm-8 col-lg-8">
                        <h4 class="color-primary">Transaksi Pembayaran Angsuran</h4>
                    </div>
					...
					<div class="col-sm-2 col-lg-2">
						<a href="<?php  echo base_url();?>angsuran/importangsuran" class="btn btn-success btn-block" >
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<form class="form-inline" action="#" method="POST" id="filterForm">
						...
						<input type="hidden" name="urltarget" id="urltarget" value="pinjaman/angsuran/dataangsuran"/>
					</form>
				</div>
			</div>				  
		</div>
...
<script src="<?php  echo base_url();?>assets/js/pinjaman/angsuran.js"></script>
<style type = "text/css">
      @media print {
