        ...
        <div class="panel-content">
                <div class="row">
                    <div class="col-sm-10 col-lg-10">
                        <h4 class="color-primary">Data Pembayaran Lancar</h4>
                    </div>
                ...
                <div class="col-sm-6 justify-content-sm-end">
                    <div class="form-inline justify-content-sm-end">
                          <form class="form-inline" action="#" method="POST" id="filterForm">
                            ...
                            <input type="hidden" name="kredit" value="lancar"/>
                            <input type="hidden" name="dataperpage" id="dataperpage" value="10"/>
                            <input type="hidden" name="urltarget" id="urltarget" value="pinjaman/pembayaran/dataLancar"/>
                          </form>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="<?php  echo base_url();?>assets/js/pinjaman/lancar.js"></script>
<style type = "text/css">
      @media print {
