<div class="col-sm-12">
    <div class="panel">
        <div class="panel-header b-primary bt-sm">
            <div class="row">
                <div class="col-sm-9 col-lg-9">
                    <h4 class="color-primary">Cetak Rekening Koran Anggota</h4>
					<?php //echo $sqlkas;?>
                </div>
        ...
        <div class="panel-content">
			...
			?>
            <form id="formSetoran" action="simpanan/simpanan/cetakrekeningkoran" method="post" class="">
			   ...
			   <div class="form-group">
                ...
                <div class="form-buttons-w">
                    <button class="btn btn-primary" type="submit"> Cetak Rekening Koran</button>
                </div>
            </form>
        </div>
    </div>
