...
*/
$autoload['libraries'] = array('Pagination','user_agent','session','form_validation', 'table', 'tree');  
...
*/
$autoload['helper'] = array('login','form','url', 'xml','text_helper','date','inflector','app');  
