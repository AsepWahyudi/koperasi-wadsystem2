...
class Struk extends TCPDF {
    ...
    public function set_nsi_header($nsi_header) {
        if($nsi_header == TRUE) {
            ...
            $output = $this->CI->ModelSimpanan->getCabang();
            ...
            $nsi_header = '<table style="width:50%;">
                    <tr>
                        <td style="width:10%;"><img src="assets/theme_admin/img/logo.png" width="70" height="70"></td>
                         <td style="width:90%;"><strong style="font-size: 14px;"> '.$output->NAMA.'</strong> <br>
                            <table>
                                <tr><td>'.$output->ALAMAT.' Tel.'.$output->TELP.'</td></tr>
                                <tr><td>Email :'.$output->EMAIL.'</td></tr> 
                                <tr><td>Web :'.$output->WEB.'</td></tr>
                            </table>
                         </td>
                     </tr>
                </table>
